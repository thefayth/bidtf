...
Prompt: Create a bold public project visual for biDTF: Dating, chemistry, nightlife, and consent-forward adult social discovery for bi, pan, fluid, queer, ENM-friendly, and questioning adults. Use layered community, archive, identity, and protected-systems symbolism without showing private dashboards or source code.

Alt text: biDTF public project visual.
